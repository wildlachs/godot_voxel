...
inline RGBLight sample_lighting_flat(
		zylann::Vector3f position_world,
		zylann::Vector3f vertex_position,
		zylann::Vector3f side_normal,
...
inline RGBLight sample_lighting(
		zylann::Vector3f position_world,
		zylann::Vector3f vertex_position,
		zylann::Vector3f side_normal,
		std::array<RGBLight, 20 * 20 * 20> lightData,
